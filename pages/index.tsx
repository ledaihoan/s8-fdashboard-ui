...
export default function IndexPage() {
  ...
  const [cryptoListData, todaySpotPriceData, yesterdaySpotPriceData] = results;

  if (cryptoListData.isError || todaySpotPriceData.isError || yesterdaySpotPriceData.isError) {
  ...
  const cryptoFeaturedDataList: CryptoFeaturedData[] = [];
  ...
  const topFeaturedDataList: CryptoFeaturedData[] = cryptoFeaturedDataList.slice(0, NUMBER_OF_FEATURED_CRYPTO_CURRENCIES);
